...
\section{Sidosryhmäanalyysi}
		...
		\centering
		\includegraphics[width=textwidth]{sidosryhmat.png}
		\caption{Ohjelmiston sidosrymät} % Raportissa tulee olla selite jokaisen kuvan/kuvion/taulukon alla
		\label{img:sidosryhmät}
	\end{figure}
