...
\section{Vaatimusten keruuprojektin aikataulu (Gantt)}
	...
	Vaatimusten keruun aikatulua on havainnollistettu Gantt-taulukon muodossa (\ref{aikatauluesimerkki}). Taulukosta ilmenee mikä vaatimusten keruumenetelmä on käytössä milloinkin.
