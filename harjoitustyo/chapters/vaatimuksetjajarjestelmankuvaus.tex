...
\subsection{Tietoyhteyskaavio}   % 3.1.2
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth]{Tietoyhteyskaavio.pdf}
...
\subsection{Navigointikaavio}     % 3.1.3
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth]{nkasiakas.pdf}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.9\textwidth]{nkmyyja.pdf}
...
\section{Käyttöliittymä}  % 3.2
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.9\textwidth]{gui/asiakas.png}
