...
%        Suorituspaikka: \textsc{???}
    ...
    \input{appendix/ganttchart}
    \input{appendix/vaatimustaulukko}
    \input{appendix/vaatimustaulukko_complete}
    \input{appendix/sidosryhmataulukko}
    \input{appendix/gui}
    \input{appendix/kayttotapaus2}
